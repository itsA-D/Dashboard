"""
Django settings for Zoop project.
"""
import os
...
AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="zoop-receipts")
...
EMAIL_FROM = env("EMAIL_FROM", default="noreply@zoop.in")
...
LOGGING = {
    ...
    "loggers": {
        ...
        "zoop": {"handlers": ["console"], "level": "INFO"},
    },
}
