...
export default function LoginPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs uppercase tracking-[0.35em] text-ember">Zaggle access</p>
      ...
      <form
        ...
        onSubmit={async (event) => {
          ...
          try {
            ...
            sessionStorage.setItem("zaggle_session_token", response.session_token);
            sessionStorage.setItem("zaggle_email", email);
